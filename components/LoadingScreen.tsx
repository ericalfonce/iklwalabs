      ...
      {visible && (
        <motion.div
          ...
          style={{
            ...
            inset: 0,
            zIndex: 9999,
            backgroundColor: dark ? "#050C1A" : "#ffffff",
            transition: "background-color 1.8s cubic-bezier(.77,0,.18,1)",
            display: "flex",
          ...
          >
            ...
            <div
              style={{
                ...
                color: dark ? "#F8FAFC" : "#050C1A",
                transition: "color 1.8s cubic-bezier(.77,0,.18,1)",
                display: "flex",
                alignItems: "center",
                lineHeight: 1,
              }}
